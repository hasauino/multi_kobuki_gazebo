...
def node():
	...
	rospy.init_node('distanceCounter3', anonymous=False) 
...
#-------------------------------------------
	...
	listener.waitForTransform('/robot_3/odom', '/robot_3/base_link', rospy.Time(0),rospy.Duration(50.0))
	
        try:
		(trans,rot) = listener.lookupTransform('/robot_3/odom', '/robot_3/base_link', rospy.Time(0))
